...
/***/ function(module, exports, __webpack_require__) {
	...
	var _evaluator = __webpack_require__(160);
	...
	var Calculator = _react2.default.createClass({
	  ...
	  clearString: function clearString() {
	  ...
	  suppressEnter: function suppressEnter(event) {
	    //if enter key
	    if (event.keyCode === 13) {
	      this.evaluate(event);
	    }
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { className: textboxClass,
	          type: 'text',
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { onKeyDown: this.suppressEnter, onClick: this.deleteChar },
	            'del'
	          ),
	          _react2.default.createElement(
	            'button',
	            { onKeyDown: this.suppressEnter, onClick: this.clearString },
	            'clear'
	          )
	        ),
	        _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { onKeyDown: this.suppressEnter, onClick: this.appendString.bind(this, "^") },
	            'x',
	            _react2.default.createElement(
	              'sup',
	              null,
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { className: 'equalButton', onClick: this.evaluate },
	            '='
	          )
	        )
	      )
	...
	function makeButton(char) {
	  return _react2.default.createElement(
	    'button',
	    { onKeyDown: this.suppressEnter, onClick: this.appendString.bind(this, char) },
	    char
	  );
	}
...
/***/ function(module, exports) {
	...
	function evaluateHelper(str) {
	  if (str.indexOf('(') === -1) {
	    ...
	    return evaluateHelper(splitStrings.startString + evaluateWithinBrackets(splitStrings.bracketString) + splitStrings.endString);
	  }
	}
